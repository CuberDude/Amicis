...
public class StudentRegisterActivity extends AppCompatActivity implements View.OnClickListener
{
    ...
    Button acceptPhoneButton,registerButton,resendOtpButton,goToLoginActivity;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        goToLoginActivity = (Button) findViewById(R.id.gotologin);

        goToLoginActivity.setOnClickListener(this);
